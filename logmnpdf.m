...
%LOGMNPDF Multinomial log probability density function (pdf).
%   Y = LOGMNPDF(X,PROB) returns the log pdf for the multinomial distribution with
...
%
%   Modified by Louis Ranjard 2017
%
